...
const commonProblemGroups = [
  {
    ...
    links: [
      { label: "Can't access course management", href: searchResultsHref({ role: "higher-ed-instructor" }) },
      { label: "Students can't see assignments", href: searchResultsHref({ role: "higher-ed-instructor" }) },
      { label: "LMS integration issues", href: searchResultsHref({ role: "higher-ed-instructor" }) },
      { label: "Grading not syncing", href: searchResultsHref({ role: "higher-ed-instructor" }) },
      { label: "Custom content not saving", href: searchResultsHref({ role: "higher-ed-instructor" }) },
      { label: "Student roster issues", href: searchResultsHref({ role: "higher-ed-instructor" }) },
    ],
  },
  {
    title: "Common problems for students",
    links: [
      { label: "Can't sign in", href: searchResultsHref({ role: "higher-ed-student" }) },
      { label: "Missing activities or assignments", href: searchResultsHref({ role: "higher-ed-student" }) },
      { label: "LMS link not working", href: searchResultsHref({ role: "higher-ed-student" }) },
      { label: "Signed in with wrong account", href: searchResultsHref({ role: "higher-ed-student" }) },
      { label: "Browser or device compatibility issue", href: searchResultsHref({ role: "higher-ed-student" }) },
      { label: "Can't access eBook", href: searchResultsHref({ role: "higher-ed-student" }) },
    ],
  },
];
